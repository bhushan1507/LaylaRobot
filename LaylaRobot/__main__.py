...
Maintained by @creatorpavan 🧑‍💻
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/pavanZbot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/phoenixfedlogs_v40"),
        InlineKeyboardButton(
...
Powered by :- [𝗣𝗔𝗩𝗔𝗡](t.me/creatorpavan)"""

layla_IMG = "https://telegra.ph/file/57dd06cd16ebf3758b195.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [𝗣𝗔𝗩𝗔𝗡](t.me/creatorpavan) \
 Supporting isnt always financial! [𝗣𝗔𝗩𝗔𝗡'𝗭 𝗦𝗨𝗣𝗣𝗢𝗥𝗧](https://t.me/pavanZsupport) \
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *𝗣𝗔𝗩𝗔𝗡'𝗭*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Pavan @creatorpavan
                 \n❍ Support Group @pavanZsupport
                 \n❍ Assistant @pavanVC_Bot.
                 \nHere is the [💾Repository](https://github.com/QueenArzoo/LaylaRobot).
                 \n\nIf you have any question about 𝗣𝗔𝗩𝗔𝗡'𝗭, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
